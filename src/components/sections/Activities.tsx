...
// Menggunakan array data agar render lebih efisien dan rapi
  ...
  return (
    <section className="w-full py-section-v-padding bg-surface-container-low">
      <div className="max-w-container-max mx-auto px-margin-x">
        ...
        {/* Grid of 3 gallery cards */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-gutter">
          {activitiesData.map((activity) => (
            <div key={activity.id} className="group relative rounded-lg overflow-hidden h-80 shadow-sm hover:shadow-xl hover:-translate-y-1.5 transition-all duration-500 cursor-pointer">
